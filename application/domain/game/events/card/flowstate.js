() => ({
  tutorial: {
    text: 'Игрок берет в руку дополнительно три костяшки. Из них <a>можно разыграть две</a>. Оставшаяся костяшка будет сброшена в колоду. В конце раунда не разыгранные костяшки возвращаются в колоду.',
  },
  limitNotReached() {
