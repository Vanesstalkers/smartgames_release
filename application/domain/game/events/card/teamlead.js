() => ({
  tutorial: {
    text: 'Игрок берет в руку дополнительно пять костяшек. Из них <a>можно разыграть одну</a>. Оставшиеся костяшки будут сброшены в колоду. В конце раунда не разыгранные костяшки возвращаются в колоду.',
  },
  limitNotReached() {
