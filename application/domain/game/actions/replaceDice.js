(function ({ diceId, zoneId }, player) {
  ...
  // if (replacedDice && zone !== replacedDice.parent()) {
  //   if (!replacedDice.relatedPlacement) replacedDice.relatedPlacement = {};
  //   replacedDice.relatedPlacement[dice.id()] = true;
  // }
  ...
  if (
    ...
    this.eventData.activeEvents.find((event) => event.name === 'diceReplacementEvent')
  ) {
