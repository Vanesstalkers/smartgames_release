({
  steps: {
    ...
    handPlanesAvailablePlace: {
      pos: 'top-right',
      text: 'Выберите к какому блоку следует его присоединить (если поле было пустой, то размещение произойдет автоматически).',
    ...
    addExtraBlock: {
      pos: 'top-right',
      text: 'Если обязательные блоки невозможно разместить на игровое поле, то можно взять в руку дополнительные блоки. Их может быть неограниченное количество, но разместить достаточно только один.',
