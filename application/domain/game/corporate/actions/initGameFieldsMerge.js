  ...
  this.initEvent(
    {
      ...
      handlers: {
        ...
        CHECK_AVAILABLE_PORTS() {
          ...
          player.notifyUser(`У центрального поля не найдено доступных портов для присоединения игрового поля команды. Либо добавьте дополнительный блок к своему полю, либо одна из команд должна вернуть свое присоединенное к центру игровое поле в руку.`,
            { hideTime: 0 });
